...
SELECT
 ...
 WHERE rno >=:s and rno <=:e
화면에서 사용자가 보고자 하는 페이지에 대한 정보를 자바코드에 전달(페이지수, 사용자가 보고싶은 페이지)
톰캣서버에게 전달해야 함.
파라미터로 넘겨받은 값을 활용하여 start값과 end값을 계산해야함
start값 계산하기
...
*/
		function pageMove(pageNumber, pageSize){
			$("#dg_emp").datagrid({
				...
				,inDblClickCell:function(index,field,value){
					alert("더블클릭");
				}
			});
		}
...
<!--============= 로그인 화면 처리 시작 =============-->		
		<div id="d_login" align="center">
			...
			<script type="text/javascript">
				var naver_id_login = new naver_id_login("gGtI7QVFF_7VqiOkx5Po", "http://localhost:8000/ajax/index_ajax.html");
