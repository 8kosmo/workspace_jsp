...
<script type="text/javascript">
	...
	function examStart(){
		...
		//******************승인처리 ajax******************
	//문제지 정보를 가져온다.
	//그런데 페이지는 이미 서버에서 클라이언트로 다운로드가 된 상태이므로 새로운 요청을 하면 페이지가 변경되는 상황이다.
	//현재 페이지는 그대로 유지 되면서 시험시작 버튼을 클릭했을 때 내용정보만 가져와서 기존 페이지에
	//끼워넣고 싶다면 ajax를 사용할 것.
		}
/* 	//멀티선택을 배제하기 위한 함수 선언
	function answer(p_dap,fname) {
		// 브라우저가 DOM구성시 같은 이름이면 자동으로 배열 전환
		for (var i = 0; i < document.getElementById("'"+fname+"'").cb.length; i++) {
			if (p_dap == i) {
				document.getElementById("'"+fname+"'").cb[i].checked = 1;
			} else {
				document.getElementById("'"+fname+"'").cb[i].checked = 0;
			}
		}
	} */
	//멀티선택을 배제하기 위한 함수 선언
	...
	function next(p_test) {	
		...
		if(p_test=='dlg_test1'){
			//선택한 답안지의 값을 담기
			var temp=1;//체크박스가 넘어갈 때 마다 1씩 증가
			//
			...
			common_window_popup('examResult.jsp','750','350','examresult');
		}
	}
</script>
</head>
<body>
	...
	$(document).ready(function() {
		...
		$('#cd_subject').combobox({
		    ...
		    ,valueField:'SUB_CD'	// Map의 담긴 값은 대문자로..
		    ,textField:'SUB_NAME'
		    ,panelHeight:'auto'
...
<!-- 
==============================================================================
							시험과목을 선택하고 수험번호 입력 창
==============================================================================
 -->
<div id="reGoTest" class="easyui-panel" title="Test Take" style="width:100%;max-width:400px;padding:30px 30px">
	<div style="margin-bottom:20px">
		<select class="easyui-combobox" id="cd_subject" label="수험과목 선택:" labelPosition="top" data-options="prompt:'수험번호를 선택하세요'" style="width:100%"></select>
	</div>
	<!-- 수험번호 입력 -->
	<div style="margin-bottom:10px">
		<input id="exam_no" name="exam_no" class="easyui-textbox" label="수험번호: " labelPosition="top" size="150px" style="width:100%">
	</div>
	<div align="center">
		<a id="btn_xxx" href="javascript:examStart()" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" style="width:100px;height:32px">시험시작</a>
	</div>
	<div id="d_isOk"></div>
</div>
<!-- 
...
==============================================================================
 -->
	...
	<div id="dlg_test1" class="easyui-dialog" style="width:700px;height:300px"
		data-options="title:'문제1',closed:'false',buttons:'#btn_test1',modal:true">
		<div id="d_test1"></div>
	</div>
	<div id="btn_test1">
	...
	<div id="dlg_test2" class="easyui-dialog" style="width:700px;height:300px"
		data-options="title:'문제2',closed:'false',buttons:'#btn_test2',modal:true">
		<div id="d_test2"></div>
	</div>
	<div id="btn_test2">
	...
	<div id="dlg_test3" class="easyui-dialog" style="width:700px;height:300px"
		data-options="title:'문제3',closed:'false',buttons:'#btn_test3',modal:true">
		<div id="d_test3"></div>
	</div>
	<div id="btn_test3">
	...
	<div id="dlg_test4" class="easyui-dialog" style="width:700px;height:300px"
		data-options="title:'문제4',closed:'false',buttons:'#btn_test4',modal:true">
		<div id="d_test4"></div>
	</div>
	<div id="btn_test4">
